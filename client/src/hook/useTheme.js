...
export const useTheme = () => {
  ...
  const theme = createTheme({
    ...
    shadows: [
      ...
      '0 16px 40px rgba(139, 107, 123, 0.24)',
      '0 20px 48px rgba(139, 107, 123, 0.28)',
      '0 24px 56px rgba(139, 107, 123, 0.32)',
      '0 28px 64px rgba(139, 107, 123, 0.36)',
      '0 32px 72px rgba(139, 107, 123, 0.4)',
      '0 36px 80px rgba(139, 107, 123, 0.44)',
      '0 40px 88px rgba(139, 107, 123, 0.48)',
      '0 44px 96px rgba(139, 107, 123, 0.52)',
      '0 48px 104px rgba(139, 107, 123, 0.56)',
      '0 52px 112px rgba(139, 107, 123, 0.6)',
      '0 56px 120px rgba(139, 107, 123, 0.64)',
      '0 60px 128px rgba(139, 107, 123, 0.68)',
      '0 64px 136px rgba(139, 107, 123, 0.72)',
      '0 68px 144px rgba(139, 107, 123, 0.76)',
      '0 72px 152px rgba(139, 107, 123, 0.8)',
      '0 76px 160px rgba(139, 107, 123, 0.84)',
      '0 80px 168px rgba(139, 107, 123, 0.88)',
      '0 84px 176px rgba(139, 107, 123, 0.92)',
      '0 88px 184px rgba(139, 107, 123, 0.96)',
      '0 92px 192px rgba(139, 107, 123, 1)',
    ],
  });
